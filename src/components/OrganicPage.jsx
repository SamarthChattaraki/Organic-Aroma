...
function ProductDetailPage() {
  ...
  const [mainMedia, setMainMedia] = useState(null); // now holds both image or video
  ...
  // 👇 Assume product.video contains the video URL
  ...
  const handleBuy = () => {
    alert(
      `You clicked Buy for ${product.name} (Qty: ${quantity}) at ₹${(
